...
<div id="title-dash" class="container">
    <h1 class="title">
        <div>
            Alterar avaliação - <span><?= $this->data['exam']['dateExam'] ?></span>
        </div>
    </h1>
</div>
...
<div id="main-dash-exam-form" class="container">
    ...
    <!-- FORMULARIO -->
    <section id="form">
        <form class="form-standard" action="<?= URL ?>/dashboard/alunos/avaliacao/alterar?student=<?= $_GET['student'] ?>&exam=<?= $_GET['exam'] ?>" method="POST">
            <input type="hidden" name="update-exam">
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="weight" name="weight" value="<?= $this->data['exam']['weight'] ?>">
                </div>
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="lean-mass" name="lean-mass" value="<?= $this->data['exam']['leanMass'] ?>">
                </div>
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="fat-mass" name="fat-mass" value="<?= $this->data['exam']['fatMass'] ?>">
                </div>
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="tbw" name="tbw" value="<?= $this->data['exam']['tbw'] ?>">
                </div>
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="ecw" name="ecw" value="<?= $this->data['exam']['ecw'] ?>">
                </div>
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="icw" name="icw" value="<?= $this->data['exam']['icw'] ?>">
                </div>
            ...
            <div class="row row-inputs">
                <div class="col start-js">
                    ...
                    <input type="number" id="systolic" name="systolic" value="<?= $this->data['exam']['systolic'] ?>">
                </div>

                <div class="col start-js">
                    <label for="diastolic">* Pressão arterial diastólica</label>
                    <input type="number" id="diastolic" name="diastolic" value="<?= $this->data['exam']['diastolic'] ?>">
                </div>
            </div>
            ...
            <div class="radio">
                ...
                <div class="col">
                    <div class="col-2">
                        <label for="smoke-not">
                            <?php if($this->data['exam']['smoke'] === 'Não'): ?>
                                <input type="radio" id="smoke-not" name="smoke" value="Não" checked>
                            <?php else: ?>
                    ...
                    <div class="col-2">
                        <label for="smoke-yes">
                            <?php if($this->data['exam']['smoke'] === 'Sim'): ?>
                                <input type="radio" id="smoke-yes" name="smoke" value="Sim" checked>
                            <?php else: ?>
                ...
                <div class="col">
                    <div class="col-2">
                        <label for="drinks-not">
                            <?php if($this->data['exam']['alcoholic'] === 'Não'): ?>
                                <input type="radio" id="drinks-not" name="alcoholic" value="Não" checked>
                            <?php else: ?>
                    ...
                    <div class="col-2">
                        <label for="drinks-little">
                            <?php if($this->data['exam']['alcoholic'] === 'Pouco'): ?>
                                <input type="radio" id="drinks-little" name="alcoholic" value="Pouco" checked>
                            <?php else: ?>
                    ...
                    <div class="col-2">
                        <label for="drinks-yes">
                            <?php if($this->data['exam']['alcoholic'] === 'Muito'): ?>
                                <input type="radio" id="drinks-yes" name="alcoholic" value="Muito" checked>
                            <?php else: ?>
            ...
            <div class="row date-exam">
                ...
                <div class="col">
                    <input id="day" type="number" name="day" placeholder="Dia" value="<?= $this->data['exam']['day'] ?>">
                    <input id="month" type="number" name="month" placeholder="Mês" value="<?= $this->data['exam']['month'] ?>">
                    <input id="year" type="number" name="year" placeholder="Ano" value="<?= $this->data['exam']['year'] ?>">
                </div>
            </div>
