...
<div id="main-academy-price" class="container">
    ...
    <!-- FORMUALRIO -->
    <section>
        <form class="form-standard" action="<?= URL ?>/dashboard/precos/alterar?key=<?= $_GET['key'] ?>" method="POST">
            <input type="hidden" name="update-price">
            ...
            <div class="row time-price">
                <div class="time start-js">
                    ...
                    <input type="number" id="time" name="time" value="<?= $this->data['time'] ?>">
                </div>
    
                <div class="price start-js">
                    <label for="price">* Preço</label>
                    <input type="number" id="price" name="price" step="0.01" value="<?= $this->data['price'] ?>">
                </div>
            </div>
            ...
            <div class="radio">
                <div class="col">
                    <div class="col-2">
                        <label for="month">
                            <?php if($this->data['month']): ?>
                                <input type="radio" id="month" name="month" value="1" checked>
                            <?php else: ?>
                                <input type="radio" id="month" name="month" value="1">
                            <?php endif ?>
                    ...
                    <div class="col-2">
                        <label for="year">
                            <?php if(!$this->data['month']): ?>
                                <input type="radio" id="year" name="month" value="0" checked>
                            <?php else: ?>
            ...
            <div id="products">
                <?php foreach($this->data['scheme'] as $scheme): ?>
                    <div class="prod-row">
                        ...
                        <input class="scheme-js" type="text" name="scheme[]" value="<?= $scheme['scheme'] ?>">
                    </div>
                <?php endforeach ?>
            </div>
            ...
            <button class="btn-standard-form btn-send-js">Alterar</button>
        </form>
    </section>
