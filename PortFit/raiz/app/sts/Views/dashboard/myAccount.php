...
<div id="main-dash-my-account" class="container">
    ...
    <section id="form-my-account">
        <form class="form-standard" action="<?= URL ?>/dashboard/minhaConta" method="POST" enctype="multipart/form-data">
            ...
            <div id="photo" class="row">
                ...
                <div class="photo">
                    <?php if($this->data['photo']): ?>
                        <img src="<?= URL ?>/assets/img/employees/<?= $this->data['photo'] ?>">
                    <?php else: ?>
    ...
    <section id="form-my-password">
        ...
        <form class="form-standard" action="<?= URL ?>/dashboard/minhaConta" method="POST">
