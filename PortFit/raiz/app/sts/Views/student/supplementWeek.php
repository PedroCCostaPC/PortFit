...
<div id="title-dash" class="container">
    <h1 class="title">
        <div>
            Suplementação da <span>semana</span>
        </div>
    </h1>
</div>
...
<div id="main-student-food-week" class="container">
    <!-- NAV DIA / SEMANA -->
    <nav>
        <a href="<?= URL ?>/aluno/suplementacao">Hoje</a>
        <a class="page" href="<?= URL ?>/aluno/suplementacao/semana">Semana</a>
    </nav>

    <section>
        <?php foreach($this->data['supplement'] as $week): ?>
            <article>
                ...
                <?php if(!$week['class']): ?>
                    <div class="overlay-food close-overlay">
                        <div class="box-food close-box">
                            ...
                            <?php foreach($week['supplement'] as $supplement): ?>
                                <div class="row">
                                    <div class="time">
                                        <h4>Horário</h4>
                                        <p><?= $supplement['time'] ?></p>
