                    ...
                    <tr>
                        <td style='padding: 20px 30px;'>
                            ...
                            <p style='font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 14px; line-height: 25px; color: " . $primaryColor . ";'>
                                ...
                                Agora você poderá acessar sua área administrativa na " . $this->academy . ".
                            </p>
                            <br>


                            <p style='font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 14px; line-height: 25px; color: " . $primaryColor . ";'>
                                Você pode acessar sua área administrativa com esse mesmo email e a senha abaixo:
                            </p>
                            ...
                            <br>
                            <p style='font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 14px; line-height: 25px; color: " . $primaryColor . ";'>
                                <b>NOTA</b>: Você pode alterar sua senha a qualquer momento na sua área administrativa.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table align='center'>
                                <tr>
                                    <td>
                                        ...
                                        <a href='" . $this->url . "/admin' style='font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 14px; color: " . $primaryColor . "; text-decoration: none;'>
