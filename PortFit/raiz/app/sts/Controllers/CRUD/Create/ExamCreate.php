...
/**
 * Class CreateExam -> Responsável por criar Exames
 */
class CreateExam {
    /**
    ...
    /**
     * Funcao para criar exame
     */
    public function newExam($student) {
        $returnError = "$this->url/dashboard/alunos/avaliacao/adicionar?student=$student";
        ...
        // Enviando ao Model
        $End = new \Sts\Models\Exam\Create();
        $End->createExam($result);

        // Finalizando
        $_SESSION['msg'] = 'Exame salvo com sucesso!';
