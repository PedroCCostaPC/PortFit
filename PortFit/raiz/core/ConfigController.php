...
class ConfigController extends Config {
    ...
    private string $url;
    /** @var array $url Recebe a URL convertida para array*/
    ...
    public function __construct() {
        ...
        if(!empty(filter_input(INPUT_GET, 'url', FILTER_DEFAULT))) {
            ...
            if(isset($this->urlArray[3])) {
                ...
                $this->urlController = $this->urlController . "\\" . $this->slugController($this->urlArray[1]);
                $this->urlController = $this->urlController . "\\" . $this->slugController($this->urlArray[2]);
                $this->urlController = $this->urlController . "\\" . $this->slugController($this->urlArray[3]);
            ...
            } elseif(isset($this->urlArray[1])) {
                $this->urlController = $this->slugController($this->urlArray[0]);
                $this->urlController = $this->urlController . "\\" . $this->slugController($this->urlArray[1]);

            } elseif(isset($this->urlArray[0])) {
                $this->urlController = $this->slugController($this->urlArray[0]);
    ...
    /**
     * Verfificar se o método existe, existindo o método carrega a página;
