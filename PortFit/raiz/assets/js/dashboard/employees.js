// FUNCAO PARA DELETAR FUNCIONARIOS
function deleteEmployee() {
    const main = document.querySelector('#main-dash-employees #employees')
...
function validateEmployee() {
    const main = document.querySelector('#form-employee form')
    ...
    // Cargo
    const position = main.querySelector('#position')
    ...
    btn.addEventListener('click', function() {
        ...
        // Validando cargo
        if(!position.value) {
            createMessage('Selecione um cargo!')
